...
async function dumpData() {
    const reportId = 'deef2942-cd22-4517-b690-bf33fcde209d';
    ...
    fs.writeFileSync('debug_dump_new.json', JSON.stringify(fullDump, null, 2));
    console.log("Dump saved to debug_dump_new.json");
}

        ...
        try {
            ...
            const processAndMerge = (newBatch: QuestionData[]) => {
                ...
                newBatch.forEach(newQ => {
                    // Standardize ID: [BookId]_[Page]_[Number]
                    // Prefer the itemId generated by the AI if it follows our pattern
                    const qNum = newQ.question_number || '0';
                    const pNum = newQ.page || 0;
                    const fallbackId = `${bookId}_${pNum}_${qNum}`;
                    const structuredId = newQ.itemId || fallbackId;
